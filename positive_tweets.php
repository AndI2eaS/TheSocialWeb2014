...
<html>
	...
	<body>
		...
		<div class="new_main">
			...
			// Select the classified as positive tweets from the database for a specific chosen brand
			$query = "SELECT tweet, opinion, label FROM results WHERE label='$post' AND opinion='Positive' ORDER BY id DESC LIMIT 80";
